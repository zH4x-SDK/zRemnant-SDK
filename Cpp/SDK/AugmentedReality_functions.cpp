...
// ()
void UARBlueprintLibrary::PinComponentToTraceResult()
{
...
// ()
void UARBlueprintLibrary::PinComponent()
{
...
// ()
void UARBlueprintLibrary::LineTraceTrackedObjects3D()
{
...
// ()
void UARBlueprintLibrary::LineTraceTrackedObjects()
{
...
// ()
void UARBlueprintLibrary::IsSessionTypeSupported()
{
...
// ()
void UARBlueprintLibrary::GetWorldMappingStatus()
{
...
// ()
void UARBlueprintLibrary::GetTrackingQuality()
{
...
// ()
void UARBlueprintLibrary::GetSupportedVideoFormats()
{
...
// ()
void UARBlueprintLibrary::GetSessionConfig()
{
...
// ()
void UARBlueprintLibrary::GetPointCloud()
{
...
// ()
void UARBlueprintLibrary::GetCurrentLightEstimate()
{
...
// ()
void UARBlueprintLibrary::GetCameraImage()
{
...
// ()
void UARBlueprintLibrary::GetCameraDepth()
{
...
// ()
void UARBlueprintLibrary::GetARSessionStatus()
{
...
// ()
void UARBlueprintLibrary::GetAllTrackedPoints()
{
...
// ()
void UARBlueprintLibrary::GetAllTrackedPlanes()
{
...
// ()
void UARBlueprintLibrary::GetAllTrackedImages()
{
...
// ()
void UARBlueprintLibrary::GetAllTrackedEnvironmentCaptureProbes()
{
...
// ()
void UARBlueprintLibrary::GetAllPins()
{
...
// ()
void UARBlueprintLibrary::GetAllGeometries()
{
...
// ()
void UARBlueprintLibrary::AddRuntimeCandidateImage()
{
...
// ()
void UARBlueprintLibrary::AddManualEnvironmentCaptureProbe()
{
...
// ()
void UARTraceResultLibrary::GetTrackedGeometry()
{
...
// ()
void UARTraceResultLibrary::GetTraceChannel()
{
...
// ()
void UARTraceResultLibrary::GetLocalToWorldTransform()
{
...
// ()
void UARTraceResultLibrary::GetLocalToTrackingTransform()
{
...
// ()
void UARTraceResultLibrary::GetDistanceFromCamera()
{
...
// ()
void UARSaveWorldAsyncTaskBlueprintProxy::ARSaveWorld()
{
...
// ()
void UARGetCandidateObjectAsyncTaskBlueprintProxy::ARGetCandidateObject()
{
...
// ()
void UARBasicLightEstimate::GetAmbientIntensityLumens()
{
...
// ()
void UARBasicLightEstimate::GetAmbientColorTemperatureKelvin()
{
...
// ()
void UARBasicLightEstimate::GetAmbientColor()
{
...
// ()
void UARPin::GetTrackedGeometry()
{
...
// ()
void UARPin::GetPinnedComponent()
{
...
// ()
void UARPin::GetLocalToWorldTransform()
{
...
// ()
void UARPin::GetLocalToTrackingTransform()
{
...
// ()
void UARSessionConfig::ShouldResetTrackedObjects()
{
...
// ()
void UARSessionConfig::ShouldResetCameraTracking()
{
...
// ()
void UARSessionConfig::ShouldRenderCameraOverlay()
{
...
// ()
void UARSessionConfig::ShouldEnableCameraTracking()
{
...
// ()
void UARSessionConfig::ShouldEnableAutoFocus()
{
...
// ()
void UARSessionConfig::GetWorldMapData()
{
...
// ()
void UARSessionConfig::GetWorldAlignment()
{
...
// ()
void UARSessionConfig::GetSessionType()
{
...
// ()
void UARSessionConfig::GetPlaneDetectionMode()
{
...
// ()
void UARSessionConfig::GetMaxNumSimultaneousImagesTracked()
{
...
// ()
void UARSessionConfig::GetLightEstimationMode()
{
...
// ()
void UARSessionConfig::GetFrameSyncMode()
{
...
// ()
void UARSessionConfig::GetFaceTrackingUpdate()
{
...
// ()
void UARSessionConfig::GetFaceTrackingDirection()
{
...
// ()
void UARSessionConfig::GetEnvironmentCaptureProbeType()
{
...
// ()
void UARSessionConfig::GetDesiredVideoFormat()
{
...
// ()
void UARSessionConfig::GetCandidateObjectList()
{
...
// ()
void UARSessionConfig::GetCandidateImageList()
{
...
// ()
void AARSharedWorldGameMode::GetARSharedWorldGameState()
{
...
// ()
void UARTrackedGeometry::IsTracked()
{
...
// ()
void UARTrackedGeometry::GetTrackingState()
{
...
// ()
void UARTrackedGeometry::GetLocalToWorldTransform()
{
...
// ()
void UARTrackedGeometry::GetLocalToTrackingTransform()
{
...
// ()
void UARTrackedGeometry::GetLastUpdateTimestamp()
{
...
// ()
void UARTrackedGeometry::GetLastUpdateFrameNumber()
{
...
// ()
void UARTrackedGeometry::GetDebugName()
{
...
// ()
void UARPlaneGeometry::GetSubsumedBy()
{
...
// ()
void UARPlaneGeometry::GetExtent()
{
...
// ()
void UARPlaneGeometry::GetCenter()
{
...
// ()
void UARPlaneGeometry::GetBoundaryPolygonInLocalSpace()
{
...
// ()
void UARTrackedImage::GetEstimateSize()
{
...
// ()
void UARTrackedImage::GetDetectedImage()
{
...
// ()
void UARFaceGeometry::GetWorldSpaceEyeTransform()
{
...
// ()
void UARFaceGeometry::GetLocalSpaceEyeTransform()
{
...
// ()
void UARFaceGeometry::GetBlendShapeValue()
{
...
// ()
void UAREnvironmentCaptureProbe::GetExtent()
{
...
// ()
void UAREnvironmentCaptureProbe::GetEnvironmentCaptureTexture()
{
...
// ()
void UARTrackedObject::GetDetectedObject()
{
...
// ()
void UARCandidateImage::GetPhysicalWidth()
{
...
// ()
void UARCandidateImage::GetPhysicalHeight()
{
...
// ()
void UARCandidateImage::GetOrientation()
{
...
// ()
void UARCandidateImage::GetFriendlyName()
{
...
// ()
void UARCandidateImage::GetCandidateTexture()
{
...
// ()
void UARCandidateObject::GetFriendlyName()
{
...
// ()
void UARCandidateObject::GetCandidateObjectData()
{
...
// ()
void UARCandidateObject::GetBoundingBox()
{
